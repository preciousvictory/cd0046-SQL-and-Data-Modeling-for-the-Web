...
Revision ID: 827a6df1f8e2
Revises: 
Create Date: 2022-08-17 17:19:14.748445
...
def upgrade():
    ...
    op.add_column('artist', sa.Column('website', sa.String(length=800), nullable=True))
